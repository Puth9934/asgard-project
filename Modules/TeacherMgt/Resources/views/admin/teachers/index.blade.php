...
@section('content-header')
    <h1>
        {{ trans('teachermgt::teachers.title.teachers') }}
    </h1>
    <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
            <div class="row">
                <div class="btn-group pull-right" style="margin: 0 15px 15px 0;">
                    ...
                    <a href="{{ route('admin.teachermgt.teacher.trashed') }}" class="btn btn-danger btn-flat" style="padding: 4px 10px;">
                    ...
                    <div class="table-responsive">
                        <table class="data-table table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="{{ route('admin.teachermgt.teacher.edit', [$teacher->id]) }}" class="btn btn-default btn-flat"><i class="fa fa-pencil"></i></a>
                                        <button class="btn btn-danger btn-flat" data-toggle="modal" data-target="#modal-delete-confirmation" data-action-target="{{ route('admin.teachermgt.teacher.destroy', [$teacher->id]) }}"><i class="fa fa-trash"></i></button>
                                    </div>
                                </td>
                            </tr>
