<div class="box-body">
    <div class='form-group{{ $errors->has("$lang.first_name") ? ' has-error' : '' }}'>
        ...
        {!! Form::text("{$lang}[first_name]", old("$lang.first_name"), ['class' => 'form-control', 'placeholder' => 'First Name']) !!}
    ...
    <div class='form-group{{ $errors->has("$lang.last_name") ? ' has-error' : '' }}'>
        ...
        {!! Form::text("{$lang}[last_name]", old("$lang.last_name"), ['class' => 'form-control', 'placeholder' => 'Last Name']) !!}
    ...
    <div class='form-group{{ $errors->has("$lang.address") ? ' has-error' : '' }}'>
        ...
        {!! Form::text("{$lang}[address]", old("$lang.address"), ['class' => 'form-control', 'placeholder' => 'Address']) !!}
