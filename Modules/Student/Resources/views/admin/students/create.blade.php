                ...
                <div class="tab-content">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="group_id" id="group_id"  disabled="true" class="form-control">
                                <option disabled="true" selected>Select Group</option>
                        ...
                        <div class='form-group{{ $errors->has("email") ? ' has-error' : '' }}'>
                            ...
                            {!! Form::text("email", old("email"), ['class' => 'form-control', 'placeholder' => 'email Number']) !!}
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#department_id').change(function () {
            ...
            // AJAX request to get Group based on the selected Department
            $.ajax({
                url: '{{ route("getGroup", ":depId") }}'.replace(':depId', depId),
                type: 'GET',
