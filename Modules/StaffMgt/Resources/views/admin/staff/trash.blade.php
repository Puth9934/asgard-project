        ...
        <div class="col-xs-12">
            <div class="row">
                <div class="btn-group pull-right" style="margin: 0 15px 15px 0;">
                    <a href="{{ route('admin.staffmgt.staff.index') }}" class="btn btn-primary btn-flat" style="padding: 4px 10px; width:100px; border-radius: 25px;">
                    ...
                    <div class="table-responsive">
                        <table class="data-table table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="{{ route('admin.staffmgt.staff.recover', [$staff->id]) }}" class="btn btn-default btn-flat"><i class="fa fa-rotate-left"></i></a>
                                        <button class="btn btn-danger btn-flat" data-toggle="modal" data-target="#modal-delete-confirmation" data-action-target="{{ route('admin.staffmgt.staff.permanentDetele', [$staff->id]) }}"><i class="fa fa-trash"></i></button>
                                    </div>
                                </td>
                            </tr>
                            <?php endforeach; ?>
